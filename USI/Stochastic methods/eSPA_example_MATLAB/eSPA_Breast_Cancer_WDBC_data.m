%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Analysis of the Breast Cancer Diagnostics Data of the University of Wisconsine 
%% The data is available at open access at Keggle as the WDBC dataset 
...
save Output/Breast_Cancer_WDBC_out.mat out_DL out_eSPA
