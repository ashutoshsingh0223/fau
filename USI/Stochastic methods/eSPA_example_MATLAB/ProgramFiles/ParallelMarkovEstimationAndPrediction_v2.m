function [ mean_err,mean_P] = ParallelMarkovEstimationAndPrediction_v2(Pi, C_pred,N_steps,Y,fraction,flag,N_anneal)
...
parfor n_ann=1:N_anneal
    [ err{n_ann},P_full{n_ann}] = CrossvalidateMarkovPredictionsParallel_v2(in{n_ann});
end
mean_err=0;mean_P=0;
for n_ann=1:N_anneal
