function [Perf,model_label,E]=EnsemblePerfomance(out_DeepNN,out_kmeans,out_pca,out_spacl,out_gmm,out_svm,out_glm,flag_AUC);
...
for t=1:T
   for n=1:N
       ...
       model_label{6}='eSPA';
       vv1=[];vv2=[];
       for kk=1:(numel(out_gmm{t,n})-1)
           vv1(kk)=max(c*out_gmm{t,n}{kk}.L_pred_valid);
           vv2(kk)=out_gmm{t,n}{kk}.L_pred_valid_Markov;
       end
       E(n,7,t)=max(vv1);
       E(n,8,t)=max(c*vv2);
       model_label{7}='GMM+NN';
       model_label{8}='GMM+Bayes';
       E(n,9,t)=c*out_svm{t,n}.L_pred_valid;
       model_label{9}='SVM';
       E(n,10,t)=out_glm{t,n}.L_pred_valid;
       model_label{10}='GLM';
