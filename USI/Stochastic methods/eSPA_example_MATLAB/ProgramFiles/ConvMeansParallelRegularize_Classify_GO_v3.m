function [out_opd] = ConvMeansParallelRegularize_Classify_GO_v3(X,pi,K,N_anneal,gamma_init,reg_param,X_valid,pi_valid,N_neurons)
...
function [out]=KHullsAlgorithmReplica_Classify_GO_v2(in)
    ...
    while and(delta_L>eps,i<=MaxIter)
        [C,L1,norm_C]=EvaluateCRegularize_GO_v3(X,gamma,T,d,K,xt2,H2,reg_param);
