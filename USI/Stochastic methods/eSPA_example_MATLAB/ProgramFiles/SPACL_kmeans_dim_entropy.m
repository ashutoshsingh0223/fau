function [out_opd] = SPACL_kmeans_dim_entropy(X,pi,K,N_anneal,out_init,reg_param,X_valid,pi_valid,N_neurons,flag_AUC)
...
function [out]=SPACL_Replica(in)
    ...
    while and(delta_L>eps,i<=MaxIter)
      ...
      [gamma]=SPACL_EvaluateGamma(X_W,pi,C,Lambda,T,K,m,d,reg_param);
