function [ mean_err] = Parallel_OPA_ANN_EstimationAndPrediction_v2(Pi, C_pred,N_steps,Y,fraction,flag,N_anneal)
...
parfor n_ann=1:N_anneal
    [ err{n_ann}] = Crossvalidate_OPA_ANN_PredictionsParallel_v2(in{n_ann});
end
mean_err=0;
for n_ann=1:N_anneal
