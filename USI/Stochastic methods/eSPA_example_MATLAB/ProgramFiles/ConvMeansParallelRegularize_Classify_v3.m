function [out_opd] = ConvMeansParallelRegularize_Classify_v3(X,pi,reg_param,X_valid,pi_valid,K,N_anneal)
...
function [out]=KHullsAlgorithmReplica_Classify_v3(in)
    X=in.X;
    X_valid=in.X_valid;
    ...
    [gamma,~]=EvaluateLabelingParallel(X,C,T,d,K,xt2);
   %T_valid=size(X_valid,2);
