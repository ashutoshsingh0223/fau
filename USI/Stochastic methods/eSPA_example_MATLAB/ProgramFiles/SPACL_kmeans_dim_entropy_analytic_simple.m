function [out_opd] = SPACL_kmeans_dim_entropy_analytic_simple(X,pi,K,N_anneal,out_init,reg_param,X_valid,pi_valid,N_neurons,flag_AUC)
...
%    [gamma_valid,LLL2]=EvaluateGammaParallel(X_valid,C,T_valid,d,K,[],xt2_valid);
    ...
    [Lambda_valid]=SPACL_EvaluateLambdaRegularize(pi,gamma2,m,K);
