function [out_DeepNN,out_kmeans,out_pca,out_spacl,out_spacl_gauge,out_gmm,out_svm,out_glm,out_lda]=ClassifyReplica_with_gauge(in)
Gauge_Aneal_Mult_Factor=40;
if in.flag_AUC==1
        tic;
...
%        end
        ...
        for ind_k=1:length(K)
            ...
            out_spacl_gauge{ind_k} = SPACL_kmeans_dim_entropy_analytic_gauge(in.X_train,in.pi_train,...
                K(ind_k),Gauge_Aneal_Mult_Factor*in.N_anneal,out_kmeans{ind_k},in.gauge_param,in.X_valid,in.pi_valid,in.N_neurons,in.flag_AUC,RG);
