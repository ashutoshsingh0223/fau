...
A_crude_oil = zeros(length(crude_oil.Production), 2);
A_crude_oil(:, 1) = 1;
...
A_kerosene = zeros(length(kerosene.Production), 2);
A_kerosene(:, 1) = 1;
...
title('Line Plot of predicted and real production for kerosene');
xlabel('Years');
ylabel('Production'); 
...
title('Line Plot of predicted and real production for crude oil');
xlabel('Years'); 
ylabel('Production'); 
legend('predicted values','actual values');
