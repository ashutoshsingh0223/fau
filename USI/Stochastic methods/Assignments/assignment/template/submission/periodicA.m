...
A_60_63 = zeros(length(temperature_60_63_series), 3);
A_60_63(:, 1) = 1;
...
A_60_70 = zeros(length(temperature_60_70_series), 3);
A_60_70(:, 1) = 1;
...
title('Line Plot of predicted and real tempertures 1960-1963');
...
title('Line Plot of predicted and real tempertures 1960-1970');
