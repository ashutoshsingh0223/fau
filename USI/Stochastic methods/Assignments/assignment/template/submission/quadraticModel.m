...
A_crude_oil = zeros(length(crude_oil.Production), 3);
A_crude_oil(:, 1) = 1;
...
A_kerosene = zeros(length(kerosene.Production), 3);
A_kerosene(:, 1) = 1;
...
% Descaling predicted and read values
...
title('Line Plot of predicted and real production for kerosene-quadratic');
xlabel('Years');
ylabel('Production'); 
...
title('Line Plot of predicted and real production for crude oil-quadratic');
xlabel('Years'); 
ylabel('Production'); 
legend('predicted values','actual values');
