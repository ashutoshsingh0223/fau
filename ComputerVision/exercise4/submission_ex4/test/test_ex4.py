...
# @pytest.mark.parametrize("left_right_translation", [
#                                                     (img_1, img_2, -15),
#                                                     (img_1, img_3, -29),
#                                                     # (img_1, img_4, -44),
#                                                     (img_3, img_4, -18)
...
#
#
# @pytest.mark.parametrize("left_right_disparity_pad_sum", [
#                                                           (img_1, img_2, 3, 15, 1146181.98575),
...
#
#
@pytest.mark.parametrize("left_right_depth_translation_threshold", [
                                                                    (img_2, img_3, depth, -18, 0.42),
